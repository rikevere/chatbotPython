    ...
    while True:
        try:
            ...
            try:
                ...
                personalidade = personas.get(personalidade_key, personas["neutro"])  # Padrão para 'neutro'
                print(f"Personalidade escolhida: {personalidade_key}")
                
                # Resto da lógica permanece o mesmo
            except Exception as e:
                print(f"Erro ao definir personalidade: {e}")
...
def chat():
    ...
    # Verifique o tipo e formato de `resposta`
